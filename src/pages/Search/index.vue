...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      removeCategoryName(){
      this.searchParams.categoryName=undifined;
      this.searchParam.category1Id=undifined,
      this.searchParam.category2Id=undifined,
      this.searchParam.category3Id=undifined,
    ...
    trademarkInfo(trademark){
     ...
     removeKeyword(){
       ...
       this.searchParams.keyword=undefine;
       this.getData();
       this.$bus.$emit('clear');
